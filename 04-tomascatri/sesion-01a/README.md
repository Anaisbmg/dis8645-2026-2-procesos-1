...
* Cuando un ascensor es diferente o le falta o agrega algo mas de lo que un ascensor convencional ya tiene, se podria decir que es un no-ascensor
* para que un ascensor sea un ascensor debe tener:
  - puerta
  - paredes con cuarta dimension
  - botones o cualquier cosa para poder presionar a que piso va o pedirlo
