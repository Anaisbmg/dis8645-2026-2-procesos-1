...
#define SCREEN_HEIGHT 23 // esta es la altura de la pantalla anterior 
                          // aún no nos dabamos cuenta de que estabamos usando el tamaño erroneo
                          // asi que le bajamos 9 al 32, para usar la pantalla sin los primeros 9 pixeles
                          // eramos noobs
...
//Hay dos display.invertDisplay, porque hace como una pequeña animación.
  ...
  display.setCursor(0, -scrollY+9); // se desplaza mediante el eje Y
                                    // el +9 dentro del eje Y es para que viaje después de los primeros 9 pixeles
                                    // al correr el código el texto del poema parte después del noveno pixel
                                    // pero al subir en el eje Y volvemos a pasar por la línea amarilla
                                    // para pensar
                                    // en este caso tenemos que delimitar el tamaño de la pantalla abajo de esos 9 pixeles amarillos 
                                    // hola
  display.print(poem);
  display.display();
